...
public class StaticBankTest {
    ...
    @Test
    public void testGetExchangeRateShouldReturnCorrectExchangeRateWhenConvertingFromUsdToHuf() {
        // given in setup

        // when
        BigDecimal result = underTest.getExchangeRate(USD, HUF);

        // then
        assertEquals(BigDecimal.valueOf(249.3), result);
    }
